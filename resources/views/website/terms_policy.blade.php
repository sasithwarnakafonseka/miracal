...
@section('content')
    <main role="main">
        <div class="container content-width text-left">
            ...
            <p>At miraclecosmatics.com, accessible from miraclecosmatics.com, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded by
                miraclecosmatics.com and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in miraclecosmatics.com. This policy is not
            ...
            <p>miraclecosmatics.com follows a standard procedure of using log files. These files log visitors when they
            ...
            <p>Like any other website, miraclecosmatics.com uses 'cookies'. These cookies are used to store information
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                miraclecosmatics.com.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on miraclecosmatics.com, which are sent
            ...
            <p>Note that miraclecosmatics.com has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>miraclecosmatics.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <p>miraclecosmatics.com does not knowingly collect any Personal Identifiable Information from children under the
