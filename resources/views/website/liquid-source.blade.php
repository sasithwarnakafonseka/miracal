...
@section('title') miracle Source @endsection
@section('content')
    <main role="main">
        ...
        <div class="container content-width">
            <div class="row miracle-bar-solution">
                <div class="col-md-12">
                    <h1><strong>miracle</strong> Source<br></h1>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 bottom-contact-us-content">
                    <p><br>e-mail: info@miracle.com<br>Telephone: +960
                        9975933<br>www.liquidaconcept.com<br><br></p>
                </div>
                <div class="col-md-3 bottom-contact-us-content"></div>
            </div>
        </div>
