...
@section('content')
    <main role="main">
        ...
        <style>
            @media only screen and (min-width: 600px) {
                ...
                .container-grid-view-2,
                .container-grid-view-3,
                .container-grid-view-4 {
        ...
        <div class="container-fluid portfolio-shop-product">
            <div class="row">
                <div class="col-sm-3 cat-filters">
                    <div class="row">
                        <div id="Categories_filters" class="col-12 portfolio-shop-product-side-menu">
                            <h1 class="shop-category-title">Categories</h1>
                            <ul>
                                @foreach ($productCatList as $productCatListitem)
                                    @php
                                        $nameProduct = str_replace(' / ', '-', $productCatListitem->name);
                                    @endphp

                                    <li> <a href="/shop?category={{ $productCatListitem->id }}"
                                            class="cat_shop_list">{{ $productCatListitem->name }}</a></li>
                                @endforeach
                            </ul>
                    ...
                    <div class="row">
                        <div id="Price_filters" class="col-12 portfolio-shop-product-side-menu">
                            <h1>Price</h1>
                            <div class="wrapper">
                                ...
                                <div class="extra-controls form-inline">
                                    <div class="form-group">
                                        <input type="text" hidden class="js-input-from form-control" value="0" />
                                        <input type="text" hidden class="js-input-to form-control" value="0" />
                                    </div>
                                </div>
                            </div>
                            <hr style="border-top: 1px solid #AE7529; margin-bottom:0px">
                    ...
                    {{-- <div class="row filter-color-row" style=" margin-left: 0px;" >
                        <div id="Color_filters" class="portfolio-shop-product-side-menu-color">
                            <h1>Colour</h1>
                            @php
                            ...
                            @foreach ($ColourFilters as $ColourFiltersitem)
                                ...
                                <li class="pointer Colour_Filters" id="ColorPicker_{{ $var }}"
                                    ...
                                    @if ($ColourFiltersitem->id == 1)<svg width="40" height="40" style="margin-right: 10px;">
                                        <circle cx="20" cy="20" r="13" style="fill:#791B21;" />
                                    </svg>@elseif($ColourFiltersitem->id==2) <svg width="40" height="40" style="margin-right: 10px;">
                                        <circle cx="20" cy="20" r="13" style="fill:#E15B7C;" />
                                    </svg>@elseif($ColourFiltersitem->id==2) <svg width="40" height="40" style="margin-right: 10px;">
                                        <circle cx="20" cy="20" r="13" style="fill:#adf802;" />
                                    </svg>
                                    @endif
                                </li>
                            @endforeach
                    ...
                    @if (count($AppellationsFilters) > 0)
                        <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="row skill-row">
                        <div class="col-6 text-left">
                            <div class="skill">
                                <span class="name"
                                    ...
                                    border-top: 1px solid #AE7529;
                                    border-bottom: 1px solid #AE7529;
                                    border-left: 1px solid #AE7529;"
                                    color="primary">
                                    Show
                                </span>
                                <span onclick="showingRows(12)" class="pointer rating">
                                    12
                                </span>
                                <span onclick="showingRows(24)" class="pointer ratingMid">
                                    24
                                </span>
                                <span onclick="showingRows(36)" class="pointer ratingend">
                                    36
                                </span>
                            </div>
                        </div>
                        <div class="col-6 text-right">
                            <div class="skill">
                                <span onclick="ShowingStile(2)" class="name pointer"
                                    style="border-top: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(255, 255, 255); border-left: 1px solid rgb(255, 255, 255); padding:0px;"
                                    color="primary">
                                    <img src="\static\2grid view.JPG" alt="" style="width:35px">
                                </span>
                                <span onclick="ShowingStile(3)" class="nameMid pointer" color="primary"
                                    style="padding:0px;"><img src="\static\3gridview.JPG" alt=""
                                        style="width:35px; margin-left: -9px;">
                                </span>
                                <span onclick="ShowingStile(4)" class="nameMid pointer" color="primary"
                                    style="padding:0px;"><img src="\static\4gridview.JPG" alt=""
                                        style="width:35px;">
                                </span>
                                <span onclick="ShowingStile(1)" class="nameEnd pointer" color="primary"
                                    style="padding:0px;"><img src="\static\listview.JPG" alt="" style="width:35px;">
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="cont">
                        {{-- container-grid-view-3 --}}
                        <div id="listShow" class="container-grid-view-3">
                            @foreach ($products as $productListitem)
                                <div class="products_view" product_color="{{ $productListitem->item_color }}"
                                    item_price_regular="{{ $productListitem->g_regular_price }}">
                                    <a class="shop-pg-product"
                                        href="/shop/product/{{ $productListitem->id }}/{{ $productListitem->name }}">
                                        <div class="single-item">
                                            <div class="col-md-6"
                                                style="text-align: center;font-size: 14px; max-width: initial;">
                                                @if ($productListitem->product_thumbnail_image != null)
                                                    <img src="/storage/{{ $productListitem->product_thumbnail_image }}"
                                                        class="img-grid-view" />
                                                @else
                                                    <img src="\static\Image-2-1.jpg" class="img-grid-view" />
                                                @endif

                                                <h1>{{ $productListitem->name }}</h1>
                                                <p class="portfolio-product-price">
                                                    ${{ $productListitem->g_regular_price }}</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
    ...
    <script src="/js/product_filters.js"></script>
    <script>
        var category = 'No_Cat';
        var showingItemsCount = 12;
        var showingItemClass = 3;
        (function($) {
            var pagify = {
                items: {},
                container: null,
        ...
        $(".container-grid-view-" + showingItemClass).pagify(showingItemsCount, ".single-item");



        function showingRows(num) {
            showingItemsCount = num;
            $(".container-grid-view-" + showingItemClass).pagify(showingItemsCount, ".single-item");
        }

        function ShowingStile(num) {

            $("#listShow").removeClass("container-grid-view-" + showingItemClass);
            $("#listShow").addClass("container-grid-view-" + num);
            $(".container-grid-view-" + num).pagify(showingItemsCount, ".single-item");
            showingItemClass = num;
        }
        ...
        // $('#location_slag_head').empty().append('<b>miracle</b> Bar Shop ');
        // $('#location_slag_body').empty().append(
        //     '<a href="/" style="color:#006738; font-weight:500;">Home</a> | <b>miracle</b> Bar Shop ');
    </script>
@endsection
